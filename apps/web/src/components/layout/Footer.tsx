    ...
    <footer className="w-full bg-black border-t border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a
                href="https://twitter.com/streamkita"
                target="_blank"
              ...
              <a
                href="https://facebook.com/streamkita"
                target="_blank"
                rel="noopener noreferrer"
                className="w-5 h-5 p-2 bg-gray-800 rounded-full text-gray-400 hover:text-red-600 hover:bg-gray-700 transition-colors duration-200"
                aria-label="Facebook"
              ...
              <a
                href="https://instagram.com/streamkita"
                target="_blank"
                rel="noopener noreferrer"
                className="w-5 h-5 p-2 bg-gray-800 rounded-full text-gray-400 hover:text-red-600 hover:bg-gray-700 transition-colors duration-200"
              ...
              <a
                href="https://youtube.com/@streamkita"
                target="_blank"
                rel="noopener noreferrer"
                className="w-5 h-5 p-2 bg-gray-800 rounded-full text-gray-400 hover:text-red-600 hover:bg-gray-700 transition-colors duration-200"
                aria-label="Youtube"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-sm text-gray-500">© 2025 StreamKita. All rights reserved.</p>
