  ...
  return (
    <main className="min-h-screen bg-warm-charcoal-100 px-4 py-12 text-cream-50">
      <div className="mx-auto max-w-md rounded-2xl border border-accent-500/20 bg-warm-charcoal-50 p-8">
        ...
        <p className="mt-2 text-sm text-cream-200">Masukkan nomor HP, email, atau username. Kami menggunakan kanal terverifikasi akun Anda.</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={async (event) => {
          ...
          <Input value={identifier} onChange={(e) => setIdentifier(e.target.value)} placeholder="Nomor HP, Email, atau Username" autoComplete="username" required />
