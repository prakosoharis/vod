...
const TermsPage = () => (
  <LegalPage
    ...
    sections={[
      ...
      { title: 'Akun dan autentikasi', content: <p>Registrasi dapat menggunakan OTP WhatsApp atau OTP email. Login rutin dapat memakai nomor HP, email, username dan password, Facebook Login, atau sesi perangkat yang sah jika fitur tersedia. Anda wajib menjaga keamanan akun dan dilarang menjual, berbagi, atau menyalahgunakannya.</p> },
