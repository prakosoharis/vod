...
echo "  • Domain: transcode.smashstream.id"
echo ""
...
echo "  • Frontend & API:    https://transcode.smashstream.id"
echo "  • MinIO Console:     https://minio.smashstream.id"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "  1. Verify Nginx host reverse proxy is configured"
echo "  2. Test public access:"
echo "     curl https://transcode.smashstream.id/health"
echo "     curl -I https://minio.smashstream.id"
echo "  3. Monitor logs:"
